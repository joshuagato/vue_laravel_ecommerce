                  ...
                  <td>
                    <div class="display-flex align-center">
                      <div class="img-product">
                        <img :src="'./images/' + fetchProductImage(cartitem.product)" :alt="fetchProductName(cartitem.product)" 
                    ...
                    <td class="product-count">
                      <form action="#" class="count-inlineflex">
                        <div @click="decreaseItemQuantity(cartitem.id, cartitem.cart)" class="qtyminus">
                          -
                        </div>
                        <input type="text" name="quantity" :value="cartitem.qty" class="qty" readonly>
                        <div @click="increaseItemQuantity(cartitem.id, cartitem.cart)" class="qtyplus">
                          +
                        </div>
                      </form>
                    </td>
                      ...
                      <td>
                        <a href="#" title="Delete" @click.prevent="deleteCartItem(cartitem.id, cartitem.cart)">
            ...
            <form action="#" method="get" accept-charset="utf-8">
              <table>
                <tbody>
                  <tr>
                    <td>Total Price</td>
                    <td class="subtotal">${{ cart ? cart.total_price : '' }}</td>
                  </tr>
                  <tr>
                    <td>Shipping</td>
                  ...
                  <tr class="total-row">
                    <td>Grand Total</td>
                    <td class="price-total">${{ cart.total_price }}</td>
                  </tr>
                </tbody>
              </table>
              <div class="btn-cart-totals">
                <router-link to="/" class="update round-black-btn" title="">Continue Shopping</router-link>
